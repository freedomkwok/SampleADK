"""YAML-configured A2A executor (inlined from imp_agent_core ConfiguredA2aExecutor)."""
...
from sample_agent.a2a.adk_a2a_execution_wrapper import AdkA2aExecutionWrapper


class ConfiguredA2aExecutor(AdkA2aExecutionWrapper):
    """Executor that builds an ADK agent from YAML `executor_config`."""
    ...
    def build_adk_agent(self) -> BaseAgent:
        """Satisfy AdkA2aExecutionWrapper after pre-building in ``__init__``."""
